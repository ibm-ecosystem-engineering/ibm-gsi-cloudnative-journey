...
-  The url of the Artifactory helm repository can be determines by following these steps:
        ...
        - In the Set Me Up Section, select the tool as "Generic" and repository as "generic-local".
        - Copy the deploy URL from the Set Me Up dialog box. That is the Artifactory helm repository URL.
