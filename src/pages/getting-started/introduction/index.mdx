...
The Learning Journey focuses on the **Partner Enterprise Sandbox**, which provides full access to an IBM Cloud **Red Hat OpenShift Cloud Platform** development cluster including a set of CNCF open-source software development lifecycle tools which show the IBM Cloud usage for full DevSecOps development.
...
With the **Cloud-Native Journey** you can choose how you want to use the **Partner Enterprise Sandbox**. You can use the self-paced agenda or work with the Partner Ecosystem Team to have a remote workshop model. The self-paced model will enable longer-term learning with the **Partner Enterprise Sandbox**.
