...
![Invoke Cloud Shell](./images/Invoke_Cloud_Shell.png)
...
- Use ibmcloud command line to log into the cloud account.
```bash
ibmcloud login -u <user_id> -p <password> -g sandbox-team-n.. -r us-south
```

![Select Account](./images/SelectAccount.png)
...
- Execute the login command in the terminal
![Execute Login Command](./images/executelogincommand.png)