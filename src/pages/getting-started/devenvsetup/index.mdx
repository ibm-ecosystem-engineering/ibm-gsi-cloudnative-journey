...
- Install kubectl,IBM Cloud plugins and oc
   ...
   ```bash
      ...
      wget https://downloads-openshift-console.appdev-cloudnative-ocp4-3b1fc50af0b2002f0241bdf5d2432efd-0000.eu-gb.containers.appdomain.cloud/amd64/linux/oc.tar
      tar -xvf oc.tar
   ```
