...
On the cloud, there are two options.

- Cloud Ready Workspaces (crw) which can be accessed over a web browser.

- Cloud Shell, a free service provided by IBM Cloud.


No need to install any tools on your desktop/laptop for using these services.
