...
- [GitHub account](http://github.com) (public, not enterprise): Create one if you do not have one aleady. If you have not logged in for a while, make sure your login is working. Make sure to add your enterprise email address as the primary address for the account.
...
### If you are going to use yoru desktop/laptop for hands on exercises, follow the instructions in Desktop/Laptop tab
...
- [OpenShift OC CLI](https://www.okd.io/download.html): Required for Red Hat OpenShift management and development
    ...
    ![security](src/pages/getting-started/prereqs/security.png)
...
On the cloud, we will utilize a development environment called Cloud Ready Workspaces (crw) which can be accessed
over a web browser. There is no need to install any tools on your desktop. 
