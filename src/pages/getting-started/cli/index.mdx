...
if [[ ${EXISTING_SECRETS} -eq 0 ]]; then
    ...
    echo "*** Pull secrets already applied to service account/${SERVICE_ACCOUNT} in the ${NAMESPACE} namespace"
fi
```
</Tab>
...
- Make a commit to the git repo and push the commit to the remote git repository or click on **Pipelines**
