...
-  Once your terminal is opened,make sure you have followed all [Prerequisites](/getting-started/prereqs) before continuing.
...
- In the left menu, select *Pipelines* -> *Pipeline Runs* and select your pipeline.
