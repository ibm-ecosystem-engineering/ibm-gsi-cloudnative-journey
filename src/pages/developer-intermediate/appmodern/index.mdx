...
## Customize your modernization strategy
...
![CP4A solution](./images/icpa-solution-diagram1.png)
...
Now that you understand the concepts and value of modernizing your applications, explore how IBM WebSphere Hybrid Edition enables you to succeed on your modernization journey. IBM WebSphere Hybrid Edition addresses the challenge of "all or none" by enabling a phased approach to digital transformation.

You can start by optimizing your existing entitlements. Moving some of your IBM WebSphere or IBM WebSphere ND cores onto IBM WebSphere Liberty increases your server capacity and decreases your cost.

Next, you’ll modernize your existing applications. Use either IBM Cloud Transformation Advisor or IBM Mono2Micro to assess your applications and their dependencies. Identify how complex each migration would be and consider the options for containerization and microservices. Use the information to create a roadmap and begin modernizing applications.

Finally, you can enable your business to become cloud native by deciding which applications you want to build directly in containers and continue to move entitlements onto IBM WebSphere Liberty to free up additional capacity.

### Optimize your transformation journey

#### IBM WebSphere Application Server

Accelerate application delivery with a highly reliable Java Enterprise Edition-based runtime environment that supports microservices and standards-based programming models designed to help you modernize at your own pace, gain visibility across workloads, analyze enterprise applications and advance your journey to Kubernetes.

#### IBM WebSphere Liberty

Use this Java EE application server with a low-overhead Java runtime environment for cloud-native apps and microservices. WebSphere Liberty was created to be highly composable, start fast, use less memory and scale easily.

#### IBM Cloud® Transformation Advisor

Analyze your on-premises workloads for modernization. Determine the complexity of your applications, estimate the development cost to move to the cloud, and get recommendations for the best target environment.

#### IBM Mono2Micro

Analyze your application to understand the runtime behavior and the business use cases it supports. Explore recommendations on how to partition your application. Customize the partitions and generate code to run them as microservices on WebSphere Liberty.

#### IBM Cloud Foundry Migration Runtime

If your organization adopted Cloud Foundry, made significant investments in the platform, and rewrote applications to take advantage of it, the IBM Cloud Foundry Migration Runtime provides a KubeCF-based platform on Red Hat OpenShift as a pragmatic Kubernetes approach to workload migration.

Use the IBM Cloud Foundry Migration Runtime to take advantage of the strategic value that Kubernetes offers. IBM Cloud Foundry Migration Runtime, coupled with a Red Hat OpenShift platform, delivers a toolset that can accelerates movement to one platform while protecting migration timelines and goals from technical and operational risks.
