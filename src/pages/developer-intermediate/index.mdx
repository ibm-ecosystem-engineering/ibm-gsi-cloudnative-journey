...
| Inventory Backend | Creating the Inventory Service with Java | [Inventory Backend](/practical/inventory-svc) | 30 mins |
| **Break** | | | 5 mins |
| Inventory BFF | Creating the Inventory BFF with GraphQL | [Inventory BFF](/practical/inventory-bff) | 25 mins |
| Inventory UI | Creating the UI microservice | [Inventory UI](/practical/inventory-ui) | 25 mins |
| CD Demo | CD Demo using ArgoCD |  | 15 mins |
| **Q & A** | | | 10 mins |
| **Optional: After the workshop** | Complete Inventory App creation using a Kubernetes cluster | [Inventory Application](/practical/inventory-app) | 60 mins |
...
| Cloud Pak for Applications | Overview | [CP4Apps](/cp4apps/overview) | 20 mins |
| Application Modernization | Overview | [AppMod](/cp4apps/appmodern) | 20 mins |
| **Break** | | | 5 mins |
...
| Modernize Legacy App | Part 1 | [Scan Existing App](/practical/appmod-exercise1-part1/) | 25 mins |
| Modernize Legacy App | Part 2 | [Analyze Results](/practical/appmod-exercise1-part2/) | 25 mins |
| Modernize Legacy App | Part 3 | [Migrate App](/practical/appmod-exercise1-part3/) | 25 mins |
| **Q & A** | | | 10 mins |
...
| **Optional: After the workshop** | Complete Inventory App creation using a Kubernetes cluster | [Inventory Application](/practical/inventory-app) | 60 mins |
| **Cover Cloud Pak for Applications and how it helps developers run existing apps, migrate apps and develop cloud native apps** | | | |
| Cloud Pak for Applications | Overview | [CP4Apps](/cp4apps/overview) | 30 mins |
| Application Modernization | Overview | [AppMod](/cp4apps/appmodern) | 30 mins |
| **Cover Transformation Advisor hands on session and showcase how it helps developers to modernize their existing applications** | | | |
| Modernize Legacy App | Part 1 | [Scan Existing App](/practical/appmod-exercise1-part1/) | 45 mins |
| Modernize Legacy App | Part 2 | [Analyze Results](/practical/appmod-exercise1-part2/) | 45 mins |
| Modernize Legacy App | Part 3 | [Migrate App](/practical/appmod-exercise1-part3/) | 45 mins |
