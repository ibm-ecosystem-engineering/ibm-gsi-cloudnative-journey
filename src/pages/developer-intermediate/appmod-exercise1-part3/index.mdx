...
Ensure you get the details of database from the instructor. The details includes
...
Ensure you don't copy and push to the git, any of the below folders and files that are used by the igc pipeline from the reference repo ‘(https://github.com/ibm-gsi-ecosystem/appmod-plants-app.git)’.
...
- Test the app
    ...
    - Click the link of the route  and add the Path /PlantsByWebSphere to access the application
...
<Tab label="igc pipeline" open="true">
...
-  The output of the exection of oc pipeline as below
    ...
    ? Select the Pipeline to use in the PipelineRun: igc-java-maven-v1-2-0
    Copying tasks from tools
    Copied Pipeline from tools/igc-java-maven-v1-2-0 to ....
    Creating PipelineRun for pipeline: transform-adv-appmod-ear-pipeline
...
![tekton-pipeline](images/ta_pipelineruns.png)
