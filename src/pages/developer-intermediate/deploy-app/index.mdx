...
<AnchorLinks>
  ...
  <AnchorLink to="#5.-clone-your-code">9. Clone your code</AnchorLink>
  <AnchorLink to="#6.-run-the-application-locally">10. Run the application locally</AnchorLink>
  <AnchorLink to="#12.-test-the-webhook">11. Test the webhook</AnchorLink>
</AnchorLinks>
...
### 5. Clone your code to you local machine
