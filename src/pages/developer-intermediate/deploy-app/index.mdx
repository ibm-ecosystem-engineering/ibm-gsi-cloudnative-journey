...
- You can test that you're connected to the cluster with the following simple command:
  ...
  ```
    ...
    **NOTE**: In case, your workshop is on Code Ready Workspaces,follow the steps in [Code Ready Workspaces Setup](/getting-started/devenvsetup#code-ready-workspace) before logging in to the cluster.
