...
- When registering a pipeline, the CLI will also set up a webhook with the git host
...
platform version (`IKS` or `OCP 4.3`).

<Tabs>
<Tab label="OpenShift 4.x Tekon">
...
<Tab label="OpenShift 4.x Jenkins">
