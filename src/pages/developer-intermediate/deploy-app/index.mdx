...
<AnchorLinks>
  ...
  <AnchorLink to="#9.-clone-your-code-to-your-local-machine">9. Clone your code</AnchorLink>
...
9. The pipeline also prompts for linting the dockerfile
   ```shell
...
### 9. Clone your code to your local machine
