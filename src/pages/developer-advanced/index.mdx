...
| Application Modernization Process | Drivers and Process for modernization of legacy application | [Overview](/developer-advanced/appmod-overview/) | 20 mins|
| Modernize Legacy Application  | Scan the Legacy Application (Step - 1) | [Scan](/developer-advanced/appmod-exercise-part1/) | 30 mins|
| Analyze with TA | Analyze the Legacy Application (Step - 2)|[Analyze](/developer-advanced/appmod-exercise-part2/) | 30 mins|
| Modernize the app | | | |
...
| Events with Kafka | | | |
| Contract testing | | | |
| OpenAPI and Swagger Editor | | [OpenAPI and Swagger](/developer-advanced/swagger-and-openapi/) | |
</Tab>
