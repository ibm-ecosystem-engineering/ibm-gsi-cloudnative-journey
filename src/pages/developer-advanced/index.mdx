...
Before you proceed, make sure you have completed developer intermediate journey and have IBM GSI Sandbox invite. It is a paid IBM Cloud account with the [Developer Tools environment](../getting-started/devenvsetup) already installed and ready for you to use, including both a Kubernetes cluster and an OpenShift cluster. (The environment is locked down to prevent creating any new services.) Also, before proceeding:
...
| **Continous Delivery** | | | |
| Continous Delivery | Overview | [CD](/developer-foundation/continuous-delivery) | 15 mins |
| Gitops & ArgoCD | Overview | [Gitops](/developer-advanced/gitops) | 15 mins |
...
| Advanced Monitoring | Advanced Monitoring | [Advanced Monitoring](/developer-advanced/monitoring/) | 30 mins |
| Advanced Log Management | Advanced Log Management | [Advanced Log Management](/developer-advanced/log-management/) | 30 mins |
