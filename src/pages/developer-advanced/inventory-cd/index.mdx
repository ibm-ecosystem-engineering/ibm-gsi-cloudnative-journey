...
1. Log into Artifactory (use `igc credentials `to obtain your credentials and login to artifactory console).Go to the Artifactory tab and select "Artifacts".
    
    ![Artifactory Menu](/images/ArtifactoryMenu.png)

2. Click on Set Me Up.
    
       ![Set Me Up](/images/Artifactory-SetMeUp.png)

3. In the Set Me Up Section, select the tool as "Generic" and repository as "generic-local".Copy the deploy URL from the Set Me Up dialog box. That is the Artifactory helm repository URL. 
