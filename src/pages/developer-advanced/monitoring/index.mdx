...
Before you start to understanding how to monitor your application instances, make sure you have [deployed an app](/getting-started/deploy-app) into your development cluster. This _Git it a Try_ uses [template-node-typescript](https://github.com/IBM/template-node-typescript/generate) as an example.
