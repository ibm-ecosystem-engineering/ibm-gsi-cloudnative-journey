...
#### image-scan
Image scan will scan the image and print the Vulnerability count as Low, Medium, High and Critical.
Based on the configured exit criteria (0 Critical) the next step would in the pipeline will continue.
...
- Replace the namespace `dev-gan2`, with your project namespace.
...
Add the below code snippet in the `Task` for building image
