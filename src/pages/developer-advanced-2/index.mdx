...
| **Operators** | | | |
| Operator Overview | Operators are a method of packaging, deploying, and managing a Kubernetes application |[Operator](/developer-advanced-2/operator/) | 15 min |
| Operator Labs | Developing operator step by step |[Operator Labs](/developer-advanced-2/operator/lab) | 45 min |
