...
| Setting the Context | Objective of the exercise | [Background](/practical/inventory-part1) | 15 mins |
| Inventory Service | Creating the Inventory Service with Java | [Inventory Service](/practical/inventory-part1#inventory-service) | 45 mins |
| Inventory BFF | Creating the Inventory BFF with GraphQL | [Inventory BFF](/practical/inventory-part1#inventory-bff) | 45 mins |
...
| Preparing for the Hands-On Labs | Setting up the Development Tools | [Dev. Tools Setup](/getting-started/devenvsetup) | 10 mins |
| Inventory UI | Creating the UI microservice | [Inventory User Interface](/practical/inventory-part1#inventory-ui) | 45 mins |
| **Optional: After the workshop** | Complete Inventory App creation using the Kubernetes cluster in your team's resource group | [Inventory Application](/practical/inventory-part1) | 60 mins |
...
| Hands On Lab | Explore CP4Apps | [CP4Apps Dashboard](/practical/cp4apps) | 40 mins |
| Application Modernization | Overview | [App Mod](/cp4apps/overview) | 20 mins |
| Hands On Lab | App Modernization with Transformation Advisor | [AppMod Exercise 1](/practical/appmod-exercise1/) | 40 mins |
...
| Setting the Context | Objective of the exercise | [Background](/practical/inventory-part1) | 15 mins |
| Preparing for the Hands-On Labs | Setting up the Development Tools | [Dev. Tools Setup](/getting-started/devenvsetup) | 10 mins |
| Inventory Service| Creating the Inventory Service with Java | [Inventory Part 1 - Service](/practical/inventory-part1#inventory-service) | 45 mins |
| Inventory BFF | Creating the Inventory BFF with GraphQL | [Inventory BFF](/practical/inventory-part1#inventory-bff) | 45 mins |
| Inventory Microservice | Creating the UI microservice | [Inventory User Interface](/practical/inventory-part1#inventory-ui) | 45 mins |
...
| Inventory Micro App, Part 1 | Creating the Inventory Service with Java | [Inventory Service](/practical/inventory-part1#inventory-service) | 45 mins |
| Inventory BFF | Creating the Inventory BFF with GraphQL | [Inventory BFF](/practical/inventory-part1#inventory-bff) | 45 mins |
| Inventory UI | Creating the UI microservice | [Inventory User Interface](/practical/inventory-part1#inventory-ui) | 45 mins |
| **Optional: After the workshop** | Complete Inventory Part 1 using the Kubernetes cluster in your team's resource group | [Inventory App](/practical/inventory-part1) | 60 mins |
| **Break** | | | 15 mins |
| **Cover Cloud Pak for Applications and how it helps developers run existing apps, migrate apps and develop cloud native apps** | | | 120 mins |
| Cloud Pak for Applications | Overview of Cloud Pak for Applications | [CP4A](/cp4apps/overview) | 20 mins |
| Hands On Lab | Explore CP4Apps | [CP4Apps Dashboard](/practical/cp4apps) | 40 mins |
