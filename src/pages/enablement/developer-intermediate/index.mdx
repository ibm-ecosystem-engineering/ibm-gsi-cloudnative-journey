...
This set of learning tasks focuses on how to use the Developer Tools environment to develop and deploy a basic cloud-native application. 
...
| Preparing for the Hands-On Labs | Setting up the Development Environment | [Dev. Environment Setup](/getting-started/devenvsetup) | 15 mins |
