...
. It enables you to access an IBM Cloud account with the [Predefined SDLC
...
**Note**: Support is provided in the `#<slack-channel>` you were provided
 with in your IBM GSI Enterprise Sandbox invite. This channel will also be
  used to share any common issues found. If can be used to provide feedback
...
| **Learn how to develop and deploy apps with enterprise SDLC** | | | 120 mins |
| What is an SDLC | Overview of Development Tools installed | [SDLC](/overview/content-overview) | 20 min |
...
| Inventory Micro App, Part 1 | Creating the Inventory BFF with GraphQL | [Inventory Part 1 - BFF](/practical/inventory-part1#inventory-bff) | 45 mins |
| Inventory Micro App, Part 1 | Creating the UI microservice | [Inventory Part 1 - User Interface](/practical/inventory-part1#inventory-ui) | 45 mins |
...
| Task                            | Description         | Link        | Time    |
| --------------------------------| ------------------  |:----------- |---------|
| Day 2 Recap | Recap of things learned in Day 1 | | 15 mins |
| Preparing for the Hands-On Labs | Setting up the Development Tools | [Dev. Tools Setup](/getting-started/devenvsetup) | 10 mins |
