...
| Inventory App | Secure the solution with App ID  | |  |
| Inventory App | Integrate Backend with Cloudant Database | | |
| **Continous Delivery** | | | |
| Continous Delivery | Overview | [CD](/concepts/continuous-delivery) | 15 mins |
