...
This learning tasks assumes that you have:
 - Reviewed the content from the Agenda: [RedHat OpenShift and IBM Kubernetes Fundamentals](#Container Concepts)
...
| Sandbox Access | Validate access to your Development Cluster |  [Validate](/enablement/checksetup) | 10 min |
...
| Welcome Message | Welcome to Cloud Native Workshop  | [Introduction](/overview/introduction) | 5 mins |
| Prerequisites | Install the prerequisite tools  | [Install Prerequisites](/getting-started/prereqs) | 10 mins |
| Sandbox Access | Validate access to your Development Cluster |  [Validate](/enablement/checksetup) | 10 mins |
