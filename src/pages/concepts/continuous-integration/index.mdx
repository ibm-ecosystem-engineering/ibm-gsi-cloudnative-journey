...
| *** Try It Yourself ***                         |         |         |     |
| Tekton Lab | Using Tekton to test new versions of applications. | [Tekton](../concepts/continuous-integration/activities/) | 30 min |
| Jenkins Lab | Using Jenkins to test new versions of applications. | [Jenkins](../concepts/continuous-integration/activities/jenkins-lab/) | 30 min |
