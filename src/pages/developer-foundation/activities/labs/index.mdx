...
These activities give you a chance to walk through basic kubernetes tasks via Katacoda. Then give them a try yourself by solving some problems from scratch.
...
| Health checks | Learn how Kubernetes checks containers health using Readiness and Liveness Probes. |<a href="https://www.katacoda.com/courses/kubernetes/liveness-readiness-healthchecks" target="_blank">Liveness and Readiness Probes</a> | 20 min |
| *** Try It Yourself ***                         |         |         |     |
