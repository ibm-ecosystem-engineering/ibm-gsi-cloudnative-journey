...
| *** Try It Yourself ***                         |         |         |     |
| Tekton Lab | Using Tekton to test new versions of applications. | [Tekton](../developer-foundation/continuous-integration/activities/) | 30 min |
| Jenkins Lab | Using Jenkins to test new versions of applications. | [Jenkins](../developer-foundation/continuous-integration/activities/jenkins-lab/) | 30 min |
