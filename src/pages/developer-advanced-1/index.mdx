...
| CD Implementation | Application Delivery with Gitops | [Gitops](/developer-advanced-1/gitops) | 15 mins |
| **Database Integration** | | | |
| Cloudant | Integrate Backend with Cloudant Database | [Cloudant](/developer-advanced-1/inventory-cloudant) | 15 mins |
| MongoDB | Integrate Backend with MongoDB Database | [MongoDB](/developer-advanced-1/inventory-mongodb) | 15 mins |
| Postgres | Integrate Backend with Postgres Database | [Postgres](/developer-advanced-1/inventory-postgres) | 15 mins |
| **Authentication** | | | |
| App ID | Secure the solution with App ID  | [App ID](/developer-advanced-1/inventory-appid/) | 15 mins |
| **API Consumption** | | | |
| API | Consume API from client applications  | [API Consumption](/developer-advanced-1/inventory-api/) | 15 mins |
| Mobile App | Mobile App consuming API's  | [Mobile App](/developer-advanced-1/inventory-mobile-app/) | 15 mins |
| **Contract Testing** | | | |
| Overview | Brief overview of Contract Testing | [Contract Testing](/developer-advanced-1/contract-testing-overview/) | 15 mins |
| Hands On Lab | Incorporate contract testing within inventory app | [Inventory Contract Testing](/developer-advanced-1/inventory-contract-testing/) | 30 mins |
| **Advanced Monitoring and Logging** | | | |
| Monitoring | Advanced Monitoring with Sysdig | [Advanced Monitoring](/developer-advanced-1/monitoring/) | 30 mins |
| Log Management | Advanced Log Management with LogDNA | [Advanced Log Management](/developer-advanced-1/log-management/) | 30 mins |
| **Advanced Microservices Techniques** | | | |
| Contract testing | | | |
| OpenAPI and Swagger Editor | | [OpenAPI and Swagger](/developer-advanced-1/swagger-and-openapi/) | |
...
| Modernize Legacy Application  | Scan the Legacy Application (Step - 1) | [Scan](/developer-advanced-1/appmod-exercise-part1/) | 30 mins|
| Analyze with TA | Analyze the Legacy Application (Step - 2)|[Analyze](/developer-advanced-1/appmod-exercise-part2/) | 30 mins|
| Migrate to Openshift | Migrate the Legacy Appliation (Step - 3)|[Migrate](/developer-advanced-1/appmod-exercise-part3/) | 30 mins|
</Tab>
