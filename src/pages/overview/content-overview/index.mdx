---
title: Whats is an DevSecOps
---

<PageDescription>

An Overview of what DevSecOps is and how it can help you
 speed up you cloud native delivery
</PageDescription>

### Overview

 To build production cloud native microservices you need to understand how DevOps works, this short video introducing the concepts of DevOps with Red Hat OpenShift
...
- **DevSecOps**: Deployment target environments that support the application development lifecycle: *dev*, *test*, and *staging*
